...
struct CmdConfig
{
    ClassChassis *chassis = nullptr;               ///< 底盘 App
    ClassImu *imu = nullptr;                       ///< 底盘 IMU App
    ClassFeedRotor *feed_rotor = nullptr;          ///< 底盘拨弹盘，仅下供弹时使用
...
private:
    ClassChassis *chassis_ = nullptr;              ///< 底盘 App 指针
    ClassImu *imu_ = nullptr;                      ///< 底盘 IMU App 指针
    ClassFeedRotor *feed_rotor_ = nullptr;         ///< 底盘拨弹盘 App 指针

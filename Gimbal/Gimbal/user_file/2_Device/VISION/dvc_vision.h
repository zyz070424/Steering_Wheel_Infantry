...
typedef struct
{
    ...
    float Target_Yaw_Deg;                 /**< 目标 yaw，云台 IMU 坐标系，单位 deg */
    float Target_Pitch_Deg;               /**< 目标 pitch，云台 IMU 坐标系，单位 deg */
...
{
    uint8_t Frame_Header; /**< 帧头 */
    float Yaw_Deg;        /**< 云台 IMU yaw，单位 deg */
    float Pitch_Deg;      /**< 云台 IMU pitch，单位 deg */
    uint8_t Frame_Tail;   /**< 帧尾 */
} Vision_UART_Tx_Data;
#pragma pack()
